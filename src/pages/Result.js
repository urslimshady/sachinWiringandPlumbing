...
const Result = () => {
    return (
        <section className="bg-gray-100">
            ...
            <h2 className="text-blue-500 font-bold text-4xl text-center">हमारी सेवाएँ</h2>
            <p className="text-gray-500 max-w-lg mx-auto text-center py-2" style={{ fontSize: '14px' }}>
            यदि आपको अपनी प्लंबिंग में किसी सहायता की आवश्यकता है, तो हमें कसास प्लंबिंग पर कॉल करें। हम विभिन्न प्रकार की प्लंबिंग और वायरिंग सेवाएँ प्रदान करते हैं
            </p>
